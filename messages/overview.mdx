...
description: "Complete guide to all 11 message types supported by the WhatsApp Client SDK"
---

# Message Types Overview

The WhatsApp Client SDK supports all 11 message types available in the WhatsApp Business API, enabling rich communication experiences with your users.
