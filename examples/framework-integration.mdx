...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/webhooks/error-handling"
  >
    Advanced error handling patterns and retry logic
  </Card>
  <Card
  ...
  >
    Testing strategies for webhook implementations
  </Card>
  <Card
  ...
  >
    Deploy your webhook service to production
  </Card>
</CardGroup>